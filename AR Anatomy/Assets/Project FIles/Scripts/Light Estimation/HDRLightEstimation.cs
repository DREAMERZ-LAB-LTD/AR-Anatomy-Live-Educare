...
public class HDRLightEstimation : MonoBehaviour
{
    ...
    void FrameChanged(ARCameraFrameEventArgs args)
    {
        if (args.lightEstimation.averageBrightness.HasValue)
        {
            ...
            m_Light.intensity = brightness.Value * lightIntensityMultiplier;
        }
        else
        {
            brightness = null;
    ...
    #region testing
    [Header("Testing")]
    public TMP_InputField lightMultiplierInputField;
    float lightIntensityMultiplier = 3;
    ...
    {
        lightMultiplierInputField.text = lightIntensityMultiplier.ToString();
    }
    public void UpdateValues()
    {
        float.TryParse(lightMultiplierInputField.text, out lightIntensityMultiplier);
    }
    #endregion
}