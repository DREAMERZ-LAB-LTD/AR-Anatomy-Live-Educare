...
#pragma warning restore 649
    ...
    private void SetupGameMenu(string appleUserId, ICredential credential)
    {
        ...
        this.AppleLoginSuccess(appleUserId, credential);
    }
    ...
    private void CheckCredentialStatusForUserId(string appleUserId)
    {
        ...
        this._appleAuthManager.GetCredentialState(
            ...
            error =>
            {
                ...
                appleIDText.text += "Error while trying to get credential state " + authorizationErrorCode.ToString() + " " + error.ToString();
                this.SetupLoginMenuForSignInWithApple();
            });
    }
    ...
    private void AttemptQuickLogin()
    {
        ...
        this._appleAuthManager.QuickLogin(
            ...
            error =>
            {
                ...
                appleIDText.text += "Quick Login Failed " + authorizationErrorCode.ToString() + " " + error.ToString();
                this.SetupLoginMenuForSignInWithApple();
            });
    }
    ...
    private void SignInWithApple()
    {
        ...
        this._appleAuthManager.LoginWithAppleId(
            ...
            credential =>
            {
                ...
                PlayerPrefs.SetString(AppleUserIdKey, credential.User);
                appleIDText.text += "Apple ID " + credential.User;
                this.SetupGameMenu(credential.User, credential);
            },
            error =>
            {
    ...
    [SerializeField] AppleLoginStruct appleLoginStruct;
    [SerializeField] AppleSignUpStruct appleSignUpStruct;
    private void AppleLoginSuccess(string appleUserId, ICredential receivedCredential)
    {

        var appleIdCredential = receivedCredential as IAppleIDCredential;

        if (appleIdCredential.Email != null && appleIdCredential.FullName != null)
        {
            appleSignUpStruct.email = appleIdCredential.Email;
            ...
            Debug.Log("Apple token SignUp: " + appleUserId);
        }

        else
        {
            //000762.099e580a14cd4ad5a8d6078342daa1f2.1438
            ...
            Debug.Log("Apple token LogIn: " + appleUserId);
            return;
        }
